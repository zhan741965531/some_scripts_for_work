...
data = read_data("模板生成\业务系统漏洞周报_20210210095954.xls")
info = data.get_info()
bumeng = info[0][0]
keshi = info[0][1]
fuzeren = info[0][2]
...
old_data = xlrd.open_workbook("模板生成\省公司现存中高危漏洞统计情况20210210.xls")
...
write_data.save("省公司现存中高危漏洞统计情况20210210.xls")



#生成模板数据
mobandata = xlrd.open_workbook("省公司现存中高危漏洞统计情况20210210.xls")
